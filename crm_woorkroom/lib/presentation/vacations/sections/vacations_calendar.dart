...
import 'package:crm_woorkroom/presentation/widgets/common/cus_scroller_bar.dart';
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      width:
                                          _squareSize + AppLayout.paddingSmall,
                                      height: _borderHeight,
                                      color: AppColor.borderColor,
                                    ),
                                    ...AppMock.employeeList.map((user) {
                                      int index = user.vacationsRequest
                                          .indexWhere((e) => e.date == date);
                                      VacationRequest? userVacation;
                                      if (index != -1) {
                                        userVacation =
                                            user.vacationsRequest[index];
                                      }
                                      return Container(
                                        width: _squareSize,
                                        height: _squareSize,
