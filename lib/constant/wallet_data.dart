...
final Coin bitcoin = Coin(
  name: "Bitcoin",
  symble: "BTC",
  icon: Assets.images.web3wallet.walletBitcoin,
  price: "\$32,129.80",
  changePercent: 2.5,
  mCap: "MCap \$893.43 Bn",
...
final Coin neo = Coin(
  name: "Neo",
  symble: "NEO",
  icon: Assets.images.web3wallet.walletNeo,
  price: "\$13,221.55",
  changePercent: 2.5,
  mCap: "MCap \$893.43 Bn",
  capitalization: '\$231,233',
...
final Coin achain = Coin(
  name: "Achain",
  symble: "ACT",
  icon: Assets.images.web3wallet.walletAchain,
  price: "\$28,312.22",
  changePercent: -2.5,
  mCap: "MCap \$893.43 Bn",
  capitalization: '\$231,233',
...
final CoinNews neoNews = CoinNews(
  ...
  news: [
    News(
      image: Assets.images.web3wallet.walletInsightsRobot.path,
...
final CoinNews bitcoinNews = CoinNews(
  ...
  news: [
    News(
      image: Assets.images.web3wallet.walletNewsImage.path,
      title: "Participate in the Corra Finance Airdrop on CoinMarketCap",
      time: "3 days ago",
    ),
    News(
